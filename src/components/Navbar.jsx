...
const Navbar = () => {
  ...
  return (
    <div className="navbar py-7 flex items-center justify-between">
      ...
      <ul
        className={`menu flex items-center sm:gap-10 gap-4 md:static fixed transform left-1/2 -translate-x-1/2 
      z-50 md:-translate-x-0 md:opacity-100 bg-white/30 backdrop-blur-md p-4 rounded-br-2xl
